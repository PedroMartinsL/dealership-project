...
import com.dealership.project.infrastructure.security.filters.JwtCustomAuthenticationFilter;
...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtCustomAuthenticationFilter jwtCustomAuthenticationFilter) throws Exception {
        return http
                ...
                .formLogin(configurer -> configurer.loginPage("/login").usernameParameter("email"))
                .authorizeHttpRequests(authorize -> {
                    authorize.requestMatchers("/login/**").permitAll();
                    authorize.requestMatchers(HttpMethod.POST, "/users/**").permitAll();
                    authorize.requestMatchers(HttpMethod.GET, "/cars/**").permitAll();
